...
This tutorial will help you to go through the basics to use Dogecoin Core after you completed the [installation instructions](/INSTALL.md). You now have `bellsd` or `luckycoin-qt` executables available to run a node, and `luckycoin-cli`/`luckycoin-tx` tools to help you transact DOGE.
