...
This means one can have an always-on bellsd instance running, and another local bellsd/luckycoin-qt instance which connects to this node and receives blocks from it.
