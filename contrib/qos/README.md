...
This means one can have an always-on dogecoind instance running, and another local dogecoind/bells-qt instance which connects to this node and receives blocks from it.
