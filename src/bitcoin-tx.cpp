...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s bells-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bells-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bells transaction") + "\n" +
              "  bells-tx [options] -create [commands]   " + _("Create hex-encoded bells transaction") + "\n" +
              "\n";
